      ...
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="{{url('/')}}/admin_dashboard">
            <!-- <img src="admin_assets/images/logo.svg" alt="logo" /> -->
            <font>DashBoard</font>
          </a>
          <a class="navbar-brand brand-logo-mini" href="{{url('/')}}/admin_dashboard">
            <!-- <img src="admin_assets/images/logo-mini.svg" alt="logo" /> -->
          </a>
        </div>
      </div>
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle" src="icon.png" alt="Profile image"> </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                <img class="img-md rounded-circle" src="icon.png" style="max-height:30px;max-width:30px;" alt="Profile image">
              ...
              <a class="dropdown-item" href="{{url('/')}}/admin_loginlogs"><i class="dropdown-item-icon mdi mdi-calendar-check-outline text-primary me-2"></i> Login Log</a>
