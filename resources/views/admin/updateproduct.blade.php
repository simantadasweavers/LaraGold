...
<body>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name="productName" id="productName" value="{{$prod->pname}}" placeholder="enter product's name"  aria-describedby="emailHelp" required>
  </div>

  <div class="mb-3">
    <label for="productCode" class="form-label">Product Code</label><span style="color:red;">*</span>
    <input type="text" class="form-control" name="productCode" id="productCode" value="{{$prod->productcode}}" placeholder="enter product's unique code(register basics)" aria-describedby="enter product unique code" required>
  </div>
